...
bool ZzSetCallStackData(CallStack *callstack_ptr, char *key_str, void *value_ptr,
                        unsigned long value_size);

ZZSTATUS
ZzBuildHook(void *target_ptr, void *replace_call_ptr, void **origin_ptr, PRECALL pre_call_ptr,
            POSTCALL post_call_ptr, bool try_near_jump, ZZHOOKTYPE hook_type);

ZZSTATUS ZzEnableHook(void *target_ptr);

ZZSTATUS ZzHook(void *target_ptr, void *replace_ptr, void **origin_ptr, PRECALL pre_call_ptr,
...
ZZSTATUS ZzHookOneInstruction(void *insn_address, PRECALL pre_call_ptr, POSTCALL post_call_ptr,
                              bool try_near_jump);
